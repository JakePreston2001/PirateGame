Shader "Custom/StylizedWater"
{
    Properties
    {
        ...
        /*
        [Header(Waves)]
        _WaveA("Wave A (dir, steepness, wavelength)", Vector) = (0.37f,0.21f,0.22f,60)
        _WaveB("Wave B (dir, steepness, wavelength)", Vector) = (0.6f,0.01f,0.18f,30)
        _WaveC("Wave B (dir, steepness, wavelength)", Vector) = (1,0,0.08f,15)
        */
    }
    SubShader
    {
